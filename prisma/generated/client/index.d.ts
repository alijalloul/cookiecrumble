...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'product' | 'user' | 'order' | 'productOrder' | 'verificationToken'
  ...
  export type OrderMinAggregateOutputType = {
    ...
    updatedAt: Date | null
    userId: string | null
    productsIdQuantity: string | null
  }
  ...
  interface OrderFieldRefs {
    ...
    readonly productsIdQuantity: FieldRef<"Order", 'String'>
  }
  ...
  export interface ProductOrderDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * const productOrderWithProductIdOnly = await prisma.productOrder.findMany({ select: { productId: true } })
     * 
    **/
    ...
    **/
     ...
     * })
     * 
     * // Create many ProductOrders and only return the `productId`
     * const productOrderWithProductIdOnly = await prisma.productOrder.createManyAndReturn({ 
     ...
     * 
    **/
    createManyAndReturn<T extends ProductOrderCreateManyAndReturnArgs<ExtArgs>>(
      args?: SelectSubset<T, ProductOrderCreateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<$Result.GetResult<Prisma.$ProductOrderPayload<ExtArgs>, T, 'createManyAndReturn'>>
  ...
  export type OrderWhereInput = {
    ...
    productsIdQuantity?: StringFilter<"Order"> | string
  ...
  export type OrderScalarWhereWithAggregatesInput = {
    ...
    productsIdQuantity?: StringWithAggregatesFilter<"Order"> | string
  }
  ...
  export type OrderUpdateInput = {
    ...
    productsIdQuantity?: StringFieldUpdateOperationsInput | string
  ...
  export type ProductOrderProductIdOrderIdCompoundUniqueInput = {
    productId: string
    orderId: string
  }
